...
import { useRegisterUserMutation } from "../../../main-app-settings/endpoints/auth.endpoints";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="register-form">
                <div className="containerInput">
                    ...
                    <div className="form-group">
                        ...
                        <input id="login" type='text' {...register('login', { required: "Login is required", minLength: 4})}
                ...
                <div className="containerInput">
                    ...
                    <div className="form-group">
                        ...
                        <input id='password-confirm' type="password" {...register('passwordConfirm', { required: 'Password is required', minLength: 8})}
                            placeholder="Enter your password" />
                    </div>
                </div>
